...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative' >
      {/* Nav Bar */}
      <header 
        className='max-w-6xl m-auto flex items-center justify-between p-4 pb-10 '
      >
      ...
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto ' >
        ...
        <form className='flex flex-col md:flex-row gap-4 w-1/2 ' onSubmit={getStartedHandler}  >
            <input 
                type="email"
            ...
            />
            <button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-start ' >
                Get Started
